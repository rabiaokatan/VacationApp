    ...
    padding: isMobile
        ...
        : isTablet
            ? EdgeInsets.symmetric(
                vertical: _size.height * 0.25, horizontal: _size.width * 0.2)
            : EdgeInsets.symmetric(
                vertical: _size.height * 0.10, horizontal: _size.width * 0.1),
    ...
    child: Column(
      ...
      children: [
        ...
        Padding(
          padding: isDesktop
              ? EdgeInsets.symmetric(
                  vertical: _size.height * 0.02, horizontal: _size.width * 0.2)
              : EdgeInsets.all(0),
          child: FAProgressBar(
